...
test(
  "createModeStatuses reports missing recipient and settlement blockers independently",
  () => {
...
test(
  "loadNodeDemoEnvironment resolves known testnet token metadata without booting the server",
  () => {
