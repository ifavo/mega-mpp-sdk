...
contract MegaMppSessionEscrowTest is Test {
    ...
    function test_delegatedSignerChannelWorks() public {
        bytes32 channelId = _openChannel({authorizedSigner: signer, deposit: 1_000_000, salt: keccak256("delegated")});
    ...
    function test_settlePaysOnlyDelta() public {
        bytes32 channelId = _openChannel({authorizedSigner: address(0), deposit: 1_000_000, salt: keccak256("delta")});
    ...
    function test_topUpIncreasesDepositAndCancelsPendingClose() public {
        bytes32 channelId = _openChannel({authorizedSigner: address(0), deposit: 500_000, salt: keccak256("topup")});
    ...
    function test_closeSettlesAndRefundsCorrectly() public {
        bytes32 channelId = _openChannel({authorizedSigner: address(0), deposit: 1_000_000, salt: keccak256("close")});
    ...
    function test_requestCloseAndWithdrawFollowGracePeriod() public {
        bytes32 channelId = _openChannel({authorizedSigner: address(0), deposit: 800_000, salt: keccak256("withdraw")});
